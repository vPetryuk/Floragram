...
from .views import post_comment_create_and_list_view, like_unlike_post, PostDeleteView, PostUpdateView, add_post_view, \
    PostDetailView, recognise_post_view, rec_confirm_post, PostHistoryUpdateView
...
urlpatterns = [
    ...
    path('<pk>/history-update/', PostHistoryUpdateView.as_view(), name='post-history-update'),
