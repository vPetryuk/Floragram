...
SECRET_KEY ="dbXB7laDSYW9XILo2fWMdBPkp3JvqFrAPnojtX3C8DSSLq619jS5eR6zCArZD16o"

ROOT_DIR = Path(__file__).resolve(strict=True).parent.parent.parent
# flowerrecognising/
APPS_DIR = ROOT_DIR / "flowerrecognising"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "flowerrecognising.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "flowerrecognising.utils.context_processors.settings_context",
